...
public final class ActivityAddNoteBinding implements ViewBinding {
  ...
  private ActivityAddNoteBinding(@NonNull ConstraintLayout rootView, @NonNull CardView ageCard,
      @NonNull FloatingActionButton btnSave, @NonNull EditText edtDesc, @NonNull EditText edtTitle,
      @NonNull CardView nameCard) {
  ...
  public static ActivityAddNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddNoteBinding((ConstraintLayout) rootView, ageCard, btnSave, edtDesc,
          edtTitle, nameCard);
    }
