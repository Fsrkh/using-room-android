...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton btnAddNote, @NonNull RecyclerView rvNoteList,
      @NonNull TextView tvEmptyText) {
    this.rootView = rootView;
    this.btnAddNote = btnAddNote;
    this.rvNoteList = rvNoteList;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvNoteList;
      RecyclerView rvNoteList = ViewBindings.findChildViewById(rootView, id);
      if (rvNoteList == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnAddNote, rvNoteList,
          tvEmptyText);
    }
